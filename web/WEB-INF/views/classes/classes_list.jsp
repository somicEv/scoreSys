...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <tbody>
            <c:forEach var="classes" items="${requestScope.classList}" >
                <tr>
                    <th><input name="" type="checkbox" value="" /></th>
                    <td>${classes.clno}</td>
                    <td>${classes.clname}</td>
                    <td>${classes.collage}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/updateClassInfo?classId=${classes.id}" class="tablelink">修改</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
