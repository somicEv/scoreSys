...
(function($) {
    ...
    $.uedWidget('ued.uedSelect', {
        ...
        _createSelect : function($el) {
			var $el = this.element, options = this.options, self = this;
			//··设置文本主体
			var $container = $('<div classes="uew-select"></div>')
			var $stateDefault = $('<div classes="uew-select-value ue-state-default"></div>')
			var $text = $('<em classes="uew-select-text"></em>')
			$stateDefault.append($text).append('<em classes="uew-icon uew-icon-triangle-1-s"></em>')
			$el.wrap($container)
		   ...
		   if($el.attr("unit")){
				var $unit =$('<span classes="uew-unit">'+$el.attr("unit")+'</span>')
